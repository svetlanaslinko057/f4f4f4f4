...
export default function ConnectionsInfluencersPage() {
  ...
  const influencers = useMemo(() => {
    return realAccounts.map(acc => ({
      ...
      // Use pre-calculated twitterScore from backend, or calculate
      twitterScore: acc.twitterScore || Math.round((acc.influence || 0.5) * 800 + (acc.engagement || 0.5) * 200),
      authorityScore: Math.round((acc.influence || 0.5) * 1000),
      followers: acc.followers || 0,
      following: acc.following || 0,
      strongConnections: Math.round((acc.smart || 0.5) * 20),
      // Add REAL to all imported accounts + their categories
    ...
    <div className="min-h-screen bg-gray-50" data-testid="influencers-page">
      <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center gap-4 text-sm">
            ...
            <div className="ml-auto flex items-center gap-2">
              <button 
                ...
                className="text-purple-600 hover:text-purple-800 flex items-center gap-1 px-2 py-1 rounded hover:bg-purple-50"
        ...
        <div className="flex items-center gap-2 mb-4 overflow-x-auto pb-2">
          <span className="px-4 py-2 rounded-lg text-sm font-medium bg-purple-100 text-purple-700 flex items-center gap-2">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Who influences the crypto market and why</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 mb-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="relative flex-1 max-w-md">
              <input
                type="text"
                placeholder="Search accounts or enter keyword to fetch from Twitter..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                onKeyDown={(e) => e.key === 'Enter' && handleLiveSearch()}
                data-testid="influencer-search"
                className="w-full px-4 pr-24 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
              {searchQuery && (
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <SelectTrigger className="w-44 h-9 bg-white" data-testid="influencer-sort">
            ...
            <button 
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-lg border transition text-sm font-medium ${
                compareMode 
            ...
            >
              ...
              {compareMode ? `${compareAccounts.length}/2` : 'Compare'}
            </button>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <span className="text-sm text-gray-500 mr-2">Groups:</span>
            <button
