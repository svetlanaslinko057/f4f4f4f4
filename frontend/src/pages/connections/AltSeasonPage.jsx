...
const ALT_SEASON_COLORS = {
  ALT_SEASON: { bg: 'bg-green-50', text: 'text-green-700', icon: Sun },
  PRE_ALT: { bg: 'bg-yellow-50', text: 'text-yellow-700', icon: TrendingUp },
  NEUTRAL: { bg: 'bg-gray-50', text: 'text-gray-700', icon: Minus },
  BTC_ONLY: { bg: 'bg-blue-50', text: 'text-blue-700', icon: Snowflake },
};
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <InfoTooltip text="Measures the likelihood of an alt season based on Hit Ratio (% of alts outperforming BTC), Breadth (% of alts in uptrend), and Market Friendliness (funding rates, OI flow).">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <InfoTooltip text="Current market conditions based on exchange data: Funding rates (negative = shorts paying longs), Open Interest changes, and Volatility levels. ALT_FRIENDLY indicates favorable conditions for altcoin rallies.">
                    <HelpCircle className="w-4 h-4 text-gray-400 hover:text-gray-600" />
                  </InfoTooltip>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <InfoTooltip text="Track record of opportunity signals: Hit Rate shows % of signals that resulted in profitable trades, False Signals shows failed predictions, Total Tracked counts all monitored opportunities.">
                    <HelpCircle className="w-4 h-4 text-gray-400 hover:text-gray-600" />
                  </InfoTooltip>
                </div>
        ...
        <Card className="bg-white border-gray-200 shadow-sm">
          <CardHeader className="border-b border-gray-100">
            <CardTitle className="flex items-center gap-2 text-gray-900">
              ...
              Top Opportunities
              <InfoTooltip text="Tokens with coordinated attention from multiple influencer clusters. Score combines momentum, cluster count, early phase bonus, and exchange bias. EARLY phase = best risk/reward.">
                <HelpCircle className="w-4 h-4 text-gray-400 hover:text-gray-600" />
              </InfoTooltip>
            </CardTitle>
          </CardHeader>
        ...
        <Card className="bg-white border-gray-200 shadow-sm mt-6">
          <CardHeader className="border-b border-gray-100">
            <CardTitle className="flex items-center gap-2 text-gray-900">
              ...
              <InfoTooltip text="Real-time token attention from influencer network. Score = weighted mentions by smart money & early signal accounts. Breadth = % of unique influencers. Active Clusters = groups discussing the token.">
                <HelpCircle className="w-4 h-4 text-gray-400 hover:text-gray-600" />
              </InfoTooltip>
            </CardTitle>
          </CardHeader>
