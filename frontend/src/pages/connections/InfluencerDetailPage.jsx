...
const StatCard = ({ label, value, icon: Icon, color = 'blue', subValue, tooltip }) => {
  ...
  const card = (
    <div className={`bg-white rounded-xl p-5 border border-gray-200 ${tooltip ? 'cursor-help' : ''}`}>
        ...
        if (result.ok) {
          ...
          if (found) {
            ...
            const transformed = {
              ...
              // Use pre-calculated twitterScore or calculate
              twitterScore: found.twitterScore || Math.round((found.influence || 0.5) * 800 + (found.engagement || 0.5) * 200),
              ...
              strongConnections: Math.round((found.smart || 0.5) * 20),
              ...
              // Calculated metrics
              engagementRate: found.engagementRate || 0,
              networkScore: found.networkScore || Math.round((found.smart || 0.5) * 100),
              ...
              <div>
                ...
                <div className="w-32 h-2 bg-gray-200 rounded-full overflow-hidden mt-2">
                  <div 
                    ...
                    style={{ 
                      width: `${Math.min(100, (influencer.authorityScore / 1000) * 100)}%`,
